...
color: #8B4513;
 ...
 word-wrap: break-word
---
//  Rangoli  Kavithai Contest  Elocution  Uri Adithal  Tug-of-war  Folk Dance 
color: #8B4513;
 font-size: 32px;
 font-family: Fugaz One;
 font-weight: 400;
...
color: #2F4F4F;
 ...
 word-wrap: break-word
---
// Username:  Registration Number:  Age:<br/> Gender:  Mobile Number:  <br/><br/><br/><br/>    Department:<br/> Year of Studying:<br/> E-Mail ID:<br/> Events to Register:
color: #FDF5E6;
 font-size: 18px;
 font-family: Fugaz One;
 font-weight: 400;
